    ...
    <div class="p-6">
        ...
        <div v-if="showForm" class="mb-4 p-4 bg-gray-100 rounded">
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-2" v-if="'order' === 'order'">
        ...
        <div class="bg-white p-4 rounded shadow">
            <h2 class="text-lg font-semibold mb-2">Order 列表</h2>
            ...
            <div v-else>
                ...
                <div v-if="!items.length" class="text-gray-500">無 Order 數據</div>
            </div>
        </div>
    </div>
</template>
<script setup>
import { ref } from 'vue';
import { fetchOrderList, createOrder, deleteOrder } from '@/api/api';
const items = ref([]);
