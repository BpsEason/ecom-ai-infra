<template>
    <div class="p-6">
        <h1 class="text-2xl font-bold mb-4">Product 管理</h1>
        <div class="mb-4">
        ...
        <div v-if="showForm" class="mb-4 p-4 bg-gray-100 rounded">
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-2" v-if="'order' === 'product'">
